...
<!DOCTYPE html>
    ...
    <body class="w-screen bg-[#131314]">
        ...
        <div class="w-screen fixed -z-10 top-20 bottom-0 pb-8 overflow-scroll scrollbar-none">
            {!! Form::open(['url' => '/shop/create', 'id' => 'formShop']) !!}
            <main class="mx-6 xl:mx-32 pt-8 grid gap-2 xl:gap-4 grid-cols-1 md:grid-cols-6 2xl:grid-cols-12 content-center justify-center">
                <div id="detailsPane" class="md:col-start-1 md:col-span-3 2xl:col-start-3 2xl:col-span-3 bg-[#98cdab] px-4 py-2 xl:px-6 rounded-xl text-xl lg:text-2xl text-black">
                    ...
                    {!! Form::text('formShopName', '' , ['class' => 'w-full form-input py-0 mb-4', 'maxlength' => '64', 'pattern' => '[A-Za-z0-9!:/&?()]']) !!}
                    ...
                    ?>
                    {!! Form::select('formShopArea', $areas, 'SD', ['id' => 'formShopArea', 'class' => 'w-full form-select py-0 mb-4']) !!}<br>
                    ...
                    <div id="formLocationCoordinates">
                        <div class="flex w-full flex-wrap items-center mb-4">
                            ...
                            {!! Form::number('formLocationX', '0', ['id' => 'formLocationX', 'class' => 'w-20 h-fit form-input py-0 ml-2 mr-4']) !!}
                            </div>
                            <div class="flex items-center">
                            {!! Form::label('formLocationY', 'Y:', []) !!}
                            {!! Form::number('formLocationY', '0', ['id' => 'formLocationY', 'class' => 'w-20 h-fit form-input py-0 ml-2 mr-4']) !!}
                            </div>
                            <div class="flex items-center">
                            {!! Form::label('formLocationZ', 'Z:', []) !!}
                            {!! Form::number('formLocationZ', '0', ['id' => 'formLocationZ', 'class' => 'w-20 h-fit form-input py-0 ml-2']) !!}
                            </div>
                        </div>
                    </div>
                    <?php
                ...
                <div id="descriptionPane" class="md:col-start-4 md:col-span-3 2xl:col-start-6 2xl:col-span-4 bg-fuchsia-200 px-2 py-2 xl:px-6 rounded-xl text-xl lg:text-2xl text-black">
                    <p class="underline text-center mb-2 text-2xl">Shop Description</p>
                    ...
                    {!! Form::textarea('formShopDescription', '', ['class' => 'w-full form-textarea p-0 mb-4', 'maxlength' => '1000']) !!}
                </div>
                <div id="inventoryPane" class="md:row-start-3 md:col-span-4 md:col-start-1 md:row-span-8 lg:col-span-3 2xl:row-start-2 2xl:col-span-3 2xl:col-start-3 bg-gray-300 px-2 py-2 xl:px-6 rounded-xl text-xl lg:text-2xl text-black">
                    <p class="underline text-center mb-2 text-2xl">Shop Inventory</p>
                    <p class="text-center mb-2 text-sm">Add your inventory here. If your shop is non-retail, leave this blank.</p>
                ...
                <div id="submitPane" class="md:row-start-3 md:col-span-2 md:col-start-5 md:row-span-1 2xl:row-start-1 2xl:col-span-2 2xl:col-start-10 max-h-40 bg-sky-400 px-2 py-2 xl:px-6 rounded-xl text-xl lg:text-2xl text-black">
                    ...
                    <p class="text-sm text-center mb-4">Check your work and then save your new shop!</p>
                    <div class="w-full text-center content-center mb-2">
                        <span class="bg-green-300 text-black px-2 rounded-lg hover:cursor-pointer" onclick="submitShop()">Save</span>
                    </div>
                </div>
                {!! Form::close() !!}
            </main>
